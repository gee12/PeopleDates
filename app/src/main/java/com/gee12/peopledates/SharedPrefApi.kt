...
import com.gee12.peopledates.utils.SingletonHolder
...
//        companion object : SingletonHolder<SharedPrefApi, Context>(::SharedPrefApi)

//        val INSTANCE = SharedPrefApi(context, gson)
    }
}